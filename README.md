...
### gradle-demo 验证
- 启动项目
![在这里插入图片描述](https://img-blog.csdnimg.cn/20200929164336883.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3poNDUyNjQ3NDU3,size_16,color_FFFFFF,t_70#pic_center)
- 浏览器访问
http://localhost:8080/helllo?name=herion
![在这里插入图片描述](https://img-blog.csdnimg.cn/2020092916450692.png#pic_center)


[demo 源码地址](https://github.com/herionZhang/gradle-parent.git)